          ...
          <div className="rounded-3xl ">
            ...
            <div className="bg-white z-10 py-2  flex justify-center flex-col shadow-2xl rounded-b-3xl">
              ...
              <div className="flex items-center px-4 ">
                ...
                <h3 className="font-poppins font-normal ">December 8th </h3>
              </div>

              <p className="mt-6 px-4 mt-1 text-[#637381] font-poppins font-medium text-sm  line-clamp-3">
                Condimentum lobortis donec nibh molestie massa dictumst cursus
                Condimentum lobortis donec nibh molestie massa dictumst
                cursus.Condimentum lobortis donec nibh molestie massa dictumst
                cursus..
              </p>

              <div className="flex justify-between mt-2 mx-4 pb-2">
                    <div className="font-poppins font-medium text-lg text-purple-700 flex items-center">$1200</div>
